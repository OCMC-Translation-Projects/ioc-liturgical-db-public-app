...
export default React.createClass({
  render() {
    const version = "1.1.8";
    return <div className="App-page-about">
      ...
      <div className="jumbotron">
        ...
        <p>The database was developed by and is maintained by staff of the Orthodox Christian Mission Center (<a className="App-link" href="http://www.ocmc.org" target="_blank">OCMC</a>).  The primary purpose of the database is for the purpose of liturgical translation and the generation of liturgical services and books.  However, it is provided as a public service to Orthodox Christians worldwide.</p>
