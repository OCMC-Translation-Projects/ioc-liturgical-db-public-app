  ...
  labels: {
    en: {
      ...
      , search: {
        ...
        , docTypeAny: "Any"
        , docTypeBiblical: "Biblical"
        , docTypeLiturgical: "Liturgical"
    ...
    , el: {
      ...
      , pageAbout: {
        ...
        , acknowledgements: "Acknowledgements"
        , ackPara01s1: "The Greek liturgical texts and the translations of the liturgical texts in this database are from AGES, Initiatives.  Please refer to the"
        , ackPara01s2: "About"
        , ackPara01s3: "page on their website regarding copyrights."
        , ackPara02s1: "Greek LXX texts are from the University of Pennsylvania (UP), Center for Computer Analysis of Texts (CCAT)."
        , ackPara03s1: "The World English Bible British Edition with Deuterocanon (webbe) is public domain."
        , ackPara04s1: "The Septuagint in American English 2012 (lxx2012) is public domain."
        , website: "Website"
      ...
      , search: {
        ...
        , docTypeBiblical: "Βιβλικό"
        , docTypeLiturgical: "Λειτουργική"
